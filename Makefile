...
PACT_BROKER_BASE_URL := http://localhost:9080
PACT_URL := ${PACT_BROKER_BASE_URL}/pacts/provider/pactflow-example-provider/consumer/pactflow-example-consumer/latest
...
ci: test_ci can_i_deploy $(DEPLOY_TARGET)

test: 
	@echo "\n========== STAGE: test (pact) and publish verification result ==========\n"
	npm run test:pact
